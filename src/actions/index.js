...
class Actions {
  ...
  initSession() {
    return (dispatch) => {
      var firebaseRef = new Firebase('https://intense-inferno-4687.firebaseio.com');
  ...
  getProducts() {
    return(dispatch) => {
      var firebaseRef = new Firebase('https://intense-inferno-4687.firebaseio.com/products');
  ...
  addComment(productId, comment) {
    return (dispatch) => {
      var firebaseRef = new Firebase('https://intense-inferno-4687.firebaseio.com/comments');
